  ...
  <div class="card card-custom card-stretch gutter-b">
    ...
    <div class="card-body pt-2 pb-0">
      ...
      <div class="table-responsive">
        <div
          v-if="this.taxIds.length"
          class="col-md-3 kt-margin-b-20-tablet-and-mobile"
        >
          <div class="kt-form__group kt-form__group--inline">
            <div class="input-group">
              <select class="form-control bootstrap-select" v-model="staff_id">
                <option
          ...
          <tbody>
            ...
            <template v-for="(tax, i) in taxes">
              <tr v-bind:key="i">
                ...
                <td>
                  <span class="text-dark font-size-lg font-weight-bold">{{
                    tax.officer_assigned_to ? "Yes" : "No"
                  }}</span>
                </td>
                <td class="pr-0 text-right">
                  ...
                  <a
                    ...
                    v-if="
                      tax.officer_approval_status === 'Approved' &&
                        !tax.final_approval
                    "
                    v-b-tooltip.hover
...
export default {
  name: "Taxes",
  components: { ApproveIcon, ArrowRightIcon },
  data() {
    return {
      taxes: [],
      getTaxesUrl: "/taxes",
  ...
  methods: {
    ...
    getTaxes() {
      axios
        ...
        .then(response => {
          this.taxes = response.data.data.docs;
        })
        .catch(error => {
    ...
    getStaffs() {
      axios
        .get(this.getStaffsUrl)
        .then(response => {
          this.staffs = response.data.data.docs;
        })
        .catch(error => {
          this.notifyError(error);
        });
